HospitalApp.controller("NurseTreatmentController", ['$scope', '$http', '$filter', '$rootScope', function ($scope, $http, $filter, $rootScope) {
    ...
    $scope.SelectedNurse=0;

    $scope.SelectedNurse=0;
   
    $scope.Details = true;
    $scope.ErrorModel = { IsPatientName: false,IsNurseName:false,IsTreatment:false };
    $scope.ErrorMessage = ""
    $scope.Add = false;
    $scope.Edit = false;
    $scope.TreatId = 0;
    ...
    $scope.TreatmentModel = { NurseTreatId: 0, TreatmentDate: "", NurseId: 0,AdmitId:0,InjectableMedications:"",Infusions:"",Oral:"",NursingCare:"" };
    ...
    $scope.EditClick = function (ProductTypeModel) {
        $scope.TreatmentModel =
                         { 
                                NurseTreatId: ProductTypeModel.NurseTreatId, 
                                TreatmentDate: ProductTypeModel.TreatmentDate, 
                                NurseId: ProductTypeModel.NurseId,
                                AdmitId: ProductTypeModel.AdmitId,
                                InjectableMedications:ProductTypeModel.InjectableMedications,
                                Infusions:ProductTypeModel.Infusions,
                                Oral:ProductTypeModel.Oral,
                                NursingCare:ProductTypeModel.NursingCare 
                          };
        $("#ddlPType").val(ProductTypeModel.AdmitId);
        $("#ddlDoctors").val(ProductTypeModel.NurseId);
