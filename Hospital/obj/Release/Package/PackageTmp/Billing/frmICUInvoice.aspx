<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmICUInvoice.aspx.cs" Inherits="Hospital.Billing.frmICUInvoice" %>
                                                ...
                                                <td style="width: 100%" colspan="3">
                                                    ...
                                                    <asp:Panel ID="pnl" ScrollBars="Horizontal" runat="server" Width="1010px" BorderColor="Green"
                                                        ...
                                                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                                                            DataKeyNames="ICUBedAllocId" GridLines="Both" Font-Names="Verdana" Width="100%"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="FullName" HeaderText="Bill Date" ReadOnly="True" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <td style="width: 100%">
                                    <asp:Panel ID="Panel2" runat="server" Width="98%" align="center" Style="text-align: center;
                                        ...
                                        <div style="float: right; position: relative; width: 80%; right: 9%; top: 2px; left: -89px;"
                                            ...
                                            <table style="margin-right: 2px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlBedMaster" runat="server" AutoPostBack="True" Width="150px"
                                                            OnSelectedIndexChanged="ddlBedMaster_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                        ...
                                        <div style="float: right; position: relative; width: 80%; margin-right: 9%; top: 0px;
                                            ...
                                            <table border="1px" cellpadding="0" cellspacing="0" width="80%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="width: 8%; border-right: none; border-left: none; border-bottom: none;
                                                        border-top: none;">
                                                        <asp:Label ID="Label2" Text="Other Charges :" runat="server" ForeColor="#3b3535" />
                                                    </td>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" DataKeyNames="ChargesId"
