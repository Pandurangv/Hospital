        ...
        <asp:Panel ID="pnlContents" runat="server" BorderStyle="Groove" CssClass="panelHeight">
            <%
                ...
                else if (ReportType.Equals("Invoice"))
                {
                    ...
                    DateTime? dtDischargeTime = new Hospital.Models.BusinessLayer.MakeDischargeBLL().GetDischargeDetailsByPatientId(Hospital.Models.DataLayer.QueryStringManager.Instance.AdmitId);
