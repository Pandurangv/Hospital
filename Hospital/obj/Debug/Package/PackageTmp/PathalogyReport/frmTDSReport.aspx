<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmTDSReport.aspx.cs" Inherits="Hospital.PathalogyReport.frmTDSReport" %>
                        ...
                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                            ...
                            <Columns>
                                <asp:BoundField DataField="ApprovedDate" HeaderText="Approved Date" ReadOnly="True"
                                    SortExpression="ApprovedDate" DataFormatString="{0:dd/MM/yyyy}" />
