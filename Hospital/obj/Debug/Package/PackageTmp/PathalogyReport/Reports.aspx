                    ...
                    <div class="col-md-6">
                        <div class="col-md-6 pull-right">
                            ...
                            <div class="col-md-4 pull-left">
                                <span class="pull-right"><strong>{{InvoiceDetails.Total}}</strong></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6 pull-right">
                            ...
                            <div class="col-md-4 pull-left">
                                <span class="pull-right"><strong>{{InvoiceDetails.FixedDiscount}}</strong></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6 pull-right">
                            ...
                            <div class="col-md-4 pull-left">
                                <span class="pull-right"><strong>{{InvoiceDetails.NetAmount}}</strong></span>
                            </div>
                        </div>
                    </div>
                </div>
