    ...
    public partial class frmIPDRegistrationBookReport : System.Web.UI.Page
    {
        ...
        private void SelectBedConsumtion()
        {
            try
            {
                ...
                List<STP_IPDRegistrationBookReportResult> lst = consume.IPDRegistrationBookPatient(StringExtension.ToDateTime(txtBillDate.Text), StringExtension.ToDateTime(txtToDate.Text));
                if (lst != null)
                {
