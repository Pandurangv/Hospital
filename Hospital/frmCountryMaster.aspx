<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmCountryMaster.aspx.cs" Inherits="Hospital.frmCountryMaster" %>
    ...
    <div style="width: 99%">
        ...
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="Country Master" Font-Names="Verdana"
                            Font-Size="16px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewCountry" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewCountry_Click" />
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="100%">
                                    <asp:GridView ID="dgvCountry" runat="server" CellPadding="4" ForeColor="#333333"
                                        DataKeyNames="CountryCode" GridLines="Both" Font-Names="Verdana" Width="100%"
                                        Font-Size="Small" AllowPaging="true" PageSize="20" AutoGenerateColumns="false" BorderColor="Green"
                                    BorderStyle="Solid" BorderWidth="1px"
                                        OnRowCommand="dgvCountry_RowCommand" OnDataBound="dgvCountry_DataBound" OnPageIndexChanged="dgvCountry_PageIndexChanged"
                                        OnPageIndexChanging="dgvCountry_PageIndexChanging" OnRowDataBound="dgvCountry_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Country Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkCountryCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditCountry" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("CountryCode") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="CountryDesc" HeaderText="Country Desc" ReadOnly="True"
                                                SortExpression="CountryDesc" />
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="Country Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblCountryCode" runat="server" Text="Country Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtCountryCode" runat="server" MaxLength="50" ReadOnly="true" Font-Names="Verdana"
                                                    Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblCountryName" runat="server" Text="Country Desciption :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtCountryDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvCountryDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtCountryDesc" Font-Size="13"
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Update Country Master" Font-Names="Verdana"
                                                    Font-Size="15px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="Country Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditCountryCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="Country Name :" Font-Names="Verdana" Font-Size="11px"
                                                    ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditCountryDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditCountryDesc" Font-Size="13"
