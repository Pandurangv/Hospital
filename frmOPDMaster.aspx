<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmOPDMaster.aspx.cs" Inherits="Hospital.frmOPDMaster" %>
    ...
    <div style="width: 99%">
        ...
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="OPD Master" Font-Names="Verdana" Font-Size="16px"
                            Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewOPD" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewOPD_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="100%">
                                    <asp:GridView ID="dgvOPD" runat="server" CellPadding="4" ForeColor="#333333" DataKeyNames="PKId"
                                        GridLines="Both" Font-Names="Verdana" Width="100%" Font-Size="Small" AllowPaging="true" BorderColor="Green"
                                    BorderStyle="Solid" BorderWidth="1px"
                                        PageSize="20" AutoGenerateColumns="false" OnRowCommand="dgvOPD_RowCommand" OnDataBound="dgvOPD_DataBound"
                                        OnPageIndexChanged="dgvOPD_PageIndexChanged" OnPageIndexChanging="dgvOPD_PageIndexChanging"
                                        OnRowDataBound="dgvOPD_RowDataBound">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="OPD Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkOPDCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditOPD" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("PKId") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="OPDDesc" HeaderText="OPD Description " ReadOnly="true" SortExpression="OPDDesc" />
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="OPD Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblOPD" runat="server" Text="OPD Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtOPDDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="150px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvOPDDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtOPDDesc" Font-Size="13"
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Update OPD Master" Font-Names="Verdana"
                                                    Font-Size="15px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                       ...
                                       <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="OPD Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditOPDDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="150px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditOPDDesc" Font-Size="13"
