<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmCurrencyMaster.aspx.cs" Inherits="Hospital.frmCurrencyMaster" %>
    ...
    <div style="width: 99%">
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="Currency Master" Font-Names="Verdana"
                            Font-Size="16px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewCurrency" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewCurrency_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="100%">
                                    <asp:GridView ID="dgvCurrency" runat="server" CellPadding="4" ForeColor="#333333" BorderColor="Green"
                                    BorderStyle="Solid" BorderWidth="1px"
                                        DataKeyNames="CurrencyCode" GridLines="Both" Font-Names="Verdana" Width="100%"
                                        Font-Size="Small" AllowPaging="true" PageSize="20" AutoGenerateColumns="false" 
                                        OnRowCommand="dgvCurrency_RowCommand" OnDataBound="dgvCurrency_DataBound" OnPageIndexChanged="dgvCurrency_PageIndexChanged"
                                        OnPageIndexChanging="dgvCurrency_PageIndexChanging" OnRowDataBound="dgvCurrency_RowDataBound">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Currency Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkCurrencyCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditCurrency" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("CurrencyCode") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="CurrencyDesc" HeaderText="Currency Desc" ReadOnly="True"
                                                SortExpression="CurrencyDesc" />                                            
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="Currency Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblCurrencyCode" runat="server" Text="Currency Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtCurrencyCode" runat="server" MaxLength="50" ReadOnly="true" Font-Names="Verdana"
                                                    Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblCurrencyName" runat="server" Text="Currency Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtCurrencyDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvCurrencyDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtCurrencyDesc" Font-Size="13"
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Update Currency Master" Font-Names="Verdana"
                                                    Font-Size="15px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="Currency Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditCurrencyCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="Currency Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditCurrencyDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditCurrencyDesc" Font-Size="13"
