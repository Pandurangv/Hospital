<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmPatientMIS.aspx.cs" Inherits="Hospital.PathalogyReport.frmPatientMIS" %>
            ...
            <div>
                ...
                <asp:Panel ID="pnlContents" runat="server" Width="100%" align="center">
                    <table style="width: 60%;" align="center">
                        ...
                        <tr>
                            <td align="left">
                                <asp:Label ID="lblAge" runat="server" Text="" Font-Bold="true"></asp:Label>
                            </td>
                            <td align="right">
                                <asp:Label ID="MRN" runat="server" Text="" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                            ...
                            <td align="right">
                                <asp:Label ID="lblBloodGroup" runat="server" Text="" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                            ...
                            <td align="right">
                                <asp:Label ID="lblDOD" runat="server" Text="" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <asp:Panel ID="Panel2" ScrollBars="Both" runat="server" Width="80%" Style="text-align: center;
                        ...
                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PayAmount" HeaderText="Received" ReadOnly="True" SortExpression="PayAmount" />
