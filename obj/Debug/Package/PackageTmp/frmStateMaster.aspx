<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmStateMaster.aspx.cs" Inherits="Hospital.frmStateMaster" %>
    ...
    <div style="width: 99%">
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="State Master" Font-Names="Verdana" Font-Size="16px"
                            Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewState" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewState_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="100%">
                                    <asp:GridView ID="dgvState" runat="server" CellPadding="4" ForeColor="#333333" DataKeyNames="StateCode"
                                        GridLines="Both" Font-Names="Verdana" Width="100%" Font-Size="Small" AllowPaging="true" BorderColor="Green"
                                    BorderStyle="Solid" BorderWidth="1px"
                                        PageSize="20" AutoGenerateColumns="false" OnRowCommand="dgvState_RowCommand"
                                        OnDataBound="dgvState_DataBound" OnPageIndexChanged="dgvState_PageIndexChanged"
                                        OnPageIndexChanging="dgvState_PageIndexChanging" OnRowDataBound="dgvState_RowDataBound">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="State Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkStateCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditState" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("StateCode") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="CountryDesc" HeaderText="Country " ReadOnly="true" SortExpression="CountryDesc" />
                                            <asp:BoundField DataField="StateDesc" HeaderText="State Desc" ReadOnly="True" SortExpression="StateDesc" />
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="State Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblStateCode" runat="server" Text="State Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtStateCode" runat="server" MaxLength="50" ReadOnly="true" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:DropDownList ID="ddlCountry" runat="server" ReadOnly="true" Font-Names="Verdana"
                                                    Font-Size="11px" Width="150px" Font-Bold="true">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblStateName" runat="server" Text="State Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtStateDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvStateDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtStateDesc" Font-Size="13"
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Update State Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="State Code :" Font-Names="Verdana" Font-Size="11px"
                                                    ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditStateCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="Label5" runat="server" Text="Country Name :" Font-Names="Verdana" Width="80px"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:DropDownList ID="ddlEditCountry" runat="server" ReadOnly="true" Font-Names="Verdana"
                                                    Font-Size="11px" Width="150px" Font-Bold="true">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="State Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditStateDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditStateDesc" Font-Size="13"
