            ...
            <div style="width: 99%">
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="View1" runat="server">
                        ...
                        <asp:HiddenField ID="LedgerId" runat="server" />
                        <asp:HiddenField ID="FromEdit" runat="server" />
                        <asp:HiddenField ID="FromEditDeduction" runat="server" />
                        <asp:HiddenField ID="Deduction" runat="server" />
                        <asp:HiddenField ID="allowance" runat="server" />
                        <asp:HiddenField ID="Delete_Charge" runat="server" />
