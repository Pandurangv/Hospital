<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmGroupMaster.aspx.cs" Inherits="Hospital.StoreForms.frmGroupMaster" %>
    ...
    <div style="width: 99%">
        ...
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="Group Master" Font-Names="Verdana" Font-Size="16px"
                            Font-Bold="true" ForeColor="#006600"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewGroup" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewGroup_Click" />
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="100%">
                                    <asp:GridView ID="dgvGroup" runat="server" CellPadding="4" ForeColor="#333333" DataKeyNames="PKId"
                                        ...
                                        OnRowCommand="dgvGroup_RowCommand" OnDataBound="dgvGroup_DataBound" OnPageIndexChanged="dgvGroup_PageIndexChanged"
                                        OnPageIndexChanging="dgvGroup_PageIndexChanging" OnRowDataBound="dgvGroup_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Group Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkGroupCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditGroup" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("PKId") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="Group Master" Font-Names="Verdana"
                                       ...
                                       <%-- <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblGroupCode" runat="server" Text="Group Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtGroupCode" runat="server" MaxLength="50" ReadOnly="true" Font-Names="Verdana"
                                                    Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>--%>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblGroupName" runat="server" Text="Group Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtGroupDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvGroupDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtGroupDesc" Font-Size="13"
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Group Master" Font-Names="Verdana" Font-Size="15px"
                                                    Font-Bold="true" ForeColor="#006600"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                       ...
                                       <%-- <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="Group Code :" Font-Names="Verdana" Font-Size="11px"
                                                    ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditGroupCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>--%>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="Group Name :" Font-Names="Verdana" Font-Size="11px"
                                                    ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditGroupDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditGroupDesc" Font-Size="13"
