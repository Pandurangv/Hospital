<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmRequisitionDetails.aspx.cs" Inherits="Hospital.StoreForms.frmRequisitionDetails" %>
    ...
    <div style="width: 99%">
        ...
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="Requisition Details" Font-Names="Verdana"
                            Font-Size="16px" Font-Bold="true" ForeColor="#006600"></asp:Label>
                    </td>
                </tr>
                <%-- <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewRequisitionDetails" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewRequisitionDetails_Click" />
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="100%">
                                    <asp:GridView ID="dgvRequisitionDetails" runat="server" CellPadding="4" ForeColor="#333333"
                                        ...
                                        BorderColor="Green" BorderStyle="Solid" BorderWidth="1px" OnRowCommand="dgvRequisitionDetails_RowCommand"
                                        OnDataBound="dgvRequisitionDetails_DataBound" OnPageIndexChanged="dgvRequisitionDetails_PageIndexChanged"
                                        OnPageIndexChanging="dgvRequisitionDetails_PageIndexChanging" OnRowDataBound="dgvRequisitionDetails_RowDataBound">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Requisition Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="GroupDesc" HeaderText="Group Desc" ReadOnly="True" SortExpression="GroupId" />
                                            <asp:BoundField DataField="RequisitionBy" HeaderText="RequisitionBy" ReadOnly="true"
                                                SortExpression="RequisitionBy" />
                                            <asp:BoundField DataField="RequisitionStatus" HeaderText="RequisitionStatus" ReadOnly="true"
                                                SortExpression="RequisitionStatus" />
        ...
        <tr>
            <td>
                ...
                <asp:Panel ID="pnlGrid" runat="server" Width="1000px" Style="text-align: center;
                    background-color: #E0F0E8; height: 500px; ">
                        ...
                        <tr>
                            <td>
                                <asp:Panel ID="Panel2" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    height: 490px;" BorderColor="Green" BorderStyle="Solid" BorderWidth="1px">
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="4">
                                                <asp:Label ID="lblHeading" runat="server" Text="Requisition Details " Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 20%;">
                                                <asp:Label ID="lblRequisitionNo" runat="server" Text="Requisition Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:Label ID="lblRequisitionCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="120px" Font-Bold="true" ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblRequisition" runat="server" Text="RequisitionBy :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:Label ID="lblRequisitionBy" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    ReadOnly="true" Font-Size="11px" Width="170px" ForeColor="#006600"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                        ...
                                        <tr>
                                            <td style="width: 100%" colspan="4">
                                                <asp:Panel ID="Panel1" ScrollBars="Both" runat="server" Width="100%" Height="300px">
                                                    <asp:GridView ID="dgvSaveRequisition" runat="server" CellPadding="4" ForeColor="#333333"
                                                        DataKeyNames="RequisitionCode" GridLines="Both" Font-Names="Verdana" Width="100%"
                                                        Font-Size="Small" AllowPaging="true" PageSize="20" AutoGenerateColumns="false"
                                                        BorderColor="Green" BorderStyle="Solid" BorderWidth="1px">
                                                        <FooterStyle BackColor="#3b3535" Font-Bold="True" ForeColor="White" />
                                                        <RowStyle BackColor="#E0F0E8" Font-Size="11px" Wrap="False" />
                                                        <PagerStyle BackColor="#3b3535" ForeColor="White" HorizontalAlign="Left" Font-Size="11px" />
                                                        <SelectedRowStyle BackColor="#006600" Font-Bold="True" ForeColor="#333333" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="ItemDesc" HeaderText="ItemDesc" ReadOnly="true" SortExpression="ItemDesc" />
                                                            <asp:TemplateField HeaderText="Quantity" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtQuantity" runat="server" Text='<%#Eval("Quantity") %>' CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                        ...
                                        <tr align="center">
                                            <td align="center" colspan="4">
                                                <asp:Button ID="BtnSave" runat="server" Text="Close Requisition" Font-Names="Verdana"
                                                    Font-Size="12px" ValidationGroup="Save" BackColor="#3b3535" ForeColor="White"
                                                    Width="125px" Style="border: 1px solid black" onmouseover="SetBtnMouseOver(this)"
                                                    onmouseout="SetBtnMouseOut(this)" OnClick="BtnSave_Click" />
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Update RequisitionDetails Master" Font-Names="Verdana"
                                                    Font-Size="15px" Font-Bold="true" ForeColor="#006600"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="RequisitionDetails Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditRequisitionDetailsCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="RequisitionDetails Name :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#006600"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditRequisitionDetailsDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditRequisitionDetailsDesc"
