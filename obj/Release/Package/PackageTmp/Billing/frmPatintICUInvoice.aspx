<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmPatintICUInvoice.aspx.cs" Inherits="Hospital.Billing.frmPatintICUInvoice" %>
                                                ...
                                                <td style="width: 100%" colspan="3">
                                                    ...
                                                    <asp:Panel ID="pnl" runat="server" Width="1010px" BorderColor="Green" BorderStyle="Solid"
                                                        ...
                                                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                                                            ...
                                                            <Columns>
                                                                <asp:BoundField DataField="BillNo" HeaderText="Bill Number" ReadOnly="True" SortExpression="BillNo" />
                                ...
                                <td style="width: 100%">
                                    <asp:Panel ID="Panel2" runat="server" Width="100%" Style="text-align: center; background-color: #E0F0E8;
                                        ...
                                        <table style="padding-left: 45%;">
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblHeading" runat="server" Text="Patient Invoice" Font-Names="Verdana"
                                        ...
                                        <div style="float: right; position: relative; width: 80%; margin-right: 9%; top: 0px;
                                            ...
                                            <asp:Panel ID="Panel1" ScrollBars="Both" BorderColor="Maroon" Width="80%" BorderWidth="1px"
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" DataKeyNames="OtherChargesId"
