    ...
    <asp:Panel ID="pnlContents" runat="server" BorderStyle="Groove" CssClass="panelHeight">
        <%
            ...
            if (ReportType.Equals("Pathology"))
            {
                ...
                List<Hospital.Models.DataLayer.STP_PrintPathologyResult> lstBill = objData.STP_PrintPathology(Convert.ToInt32(Session["LabId"])).ToList();
                if (lstBill.Count > 0)
                {
            ...
            {
                StringBuilder sb = new StringBuilder();
                List<Hospital.Models.DataLayer.STP_PrintPatientInvoiceResult> lstBill = objData.STP_PrintPatientInvoice(Convert.ToInt32(Session["BILLNo"])).ToList();
            ...
            {
                StringBuilder sb = new StringBuilder();
                List<Hospital.Models.DataLayer.STP_GetOPDPaperDetailResult> lstBill = objData.STP_GetOPDPaperDetail(Convert.ToInt32(Session["AdmitId"])).ToList();
                if (lstBill[0].PatientType == "OPD")
                {
                    sb.Append("<div style='border:1px solid;height:1260px;width:900px;'><table align='center' style='border:1px solid;' width='900px'><tr height='100'><td height='100'><table width='100%' Height='100%'><tr>");
                    sb.Append("<td  width='100%' align='center'><img src='../images/BannerImages/HospitalNameGNH.png'  alt='#' width='100%' align='Left'/>");
                    sb.Append("</td></tr><tr><td width='100%' align='center'><strong>");
                    sb.Append("</strong></td></tr>");
                    sb.Append("<tr><td width='100%' align='center'> <hr></td></tr>");
                    ...
                    sb.Append("<td style='width:15%;' align='left'><strong>OPD No </strong></td><td style='width:27%;' align='left'><strong> :- ");
                    sb.Append(lstBill[0].OPDNo).Append("</strong></td></tr>");
            ...
            {
                StringBuilder sb = new StringBuilder();
                List<Hospital.Models.DataLayer.STP_GetOperaConsultResult> lstOperCon = objData.STP_GetOperaConsult(Convert.ToInt32(Session["AdmintId"])).ToList();
                List<Hospital.Models.DataLayer.STP_GetDischargeTestResult> lstDisTest = objData.STP_GetDischargeTest(Convert.ToInt32(Session["AdmintId"])).ToList();
                List<Hospital.Models.DataLayer.STP_GetDischargeDetailsResult> lstDischarge = objData.STP_GetDischargeDetails(Convert.ToInt32(Session["DischargeId"])).ToList();
                DateTime Today = DateTime.Now.Date;
            ...
            else if (ReportType.Equals("Salary"))
            {
                ...
                List<Hospital.Models.DataLayer.STP_PrintSalaryResult> lstBill = objData.STP_PrintSalary(Convert.ToInt32(Session["LedgerId"])).ToList();
            ...
            {
                StringBuilder sb = new StringBuilder();
                List<Hospital.Models.DataLayer.STP_PrintMedicalReportResult> lstDischarge = objData.STP_PrintMedicalReport(Convert.ToInt32(Session["Certi_ID"])).ToList();
                sb.Append("<div border='1px' style='border-radius:25px; width:100%; height:100%;'><table width='100%' height='100%' style='padding-bottom:20px;border:1px solid;'>");
            ...
            {
                StringBuilder sb = new StringBuilder();
                List<Hospital.Models.DataLayer.STP_PrintNursingFollowupSheetResult> lstBill = objData.STP_PrintNursingFollowupSheet(Convert.ToInt32(Session["Sr_No"])).ToList();
