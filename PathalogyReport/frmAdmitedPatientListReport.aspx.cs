    ...
    public partial class frmAdmitedPatientListReport : System.Web.UI.Page
    {
        ...
        private void SelectBedConsumtion()
        {
            try
            {
                ...
                List<STP_AdmitedPatientListReportResult> lst = consume.AdmitedPatientListReport(StringExtension.ToDateTime(txtBillDate.Text), StringExtension.ToDateTime(txtToDate.Text));
                if (lst != null)
                {
