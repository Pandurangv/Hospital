    ...
    public partial class frmDatewiseInsuranceClaim : System.Web.UI.Page
    {
        ...
        private void SelectTdsReport()
        {
            try
            {
                ...
                List<STP_DatewisInsuranceClaimReportResult> lst = consume.SearchDatewiseInsurance(StringExtension.ToDateTime(txtBillDate.Text), StringExtension.ToDateTime(txtToDate.Text));
                if (lst != null)
                {
