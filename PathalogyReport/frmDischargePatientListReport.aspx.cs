    ...
    public partial class frmDischargePatientListReport : System.Web.UI.Page
    {
        ...
        private void SelectBedConsumtion()
        {
            try
            {
                ...
                List<STP_DischargePatientListReportResult> lst = consume.NewAllDischargePatient(StringExtension.ToDateTime(txtBillDate.Text), StringExtension.ToDateTime(txtToDate.Text));
                if (lst != null)
                {
