<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmPatientMainType.aspx.cs" Inherits="Hospital.frmPatientMainType" %>
    ...
    <div style="width: 99%">
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="Patient Master" Font-Names="Verdana"
                            Font-Size="16px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewPatientType" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewPatient_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl"  runat="server" Width="100%">
                                    <asp:GridView ID="dgvPatient" runat="server" CellPadding="4" ForeColor="#333333" BorderColor="Green"
                                    BorderStyle="Solid" BorderWidth="1px"
                                        DataKeyNames="PatientCode" GridLines="Both" Font-Names="Verdana" Width="100%"
                                        Font-Size="Small" AllowPaging="true" PageSize="20" AutoGenerateColumns="false"
                                        OnRowCommand="dgvPatient_RowCommand" OnDataBound="dgvPatient_DataBound" OnPageIndexChanged="dgvPatient_PageIndexChanged"
                                        OnPageIndexChanging="dgvPatient_PageIndexChanging" 
                                        OnRowDataBound="dgvPatient_RowDataBound" >
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Patient Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkPatientCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditPatient" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("PatientCode") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="PatientDesc" HeaderText="Patient Desc" ReadOnly="True"
                                                SortExpression="PatientDesc" />
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="Patient Main Type Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblPatientCode" runat="server" Text="Patient Code :" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblPatientName" runat="server" Text="Patient Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtPatientDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvPatientDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtPatientDesc" Font-Size="13"
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Update Patient Main Type Master" Font-Names="Verdana"
                                                    Font-Size="15px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="Patient Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditPatientCode" runat="server" MaxLength="50" ReadOnly="true"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtEditPatientDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditPatientDesc" Font-Size="13"
