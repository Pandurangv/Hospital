<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmBedAllocToPatient.aspx.cs" Inherits="Hospital.BedStatus.frmBedAllocToPatient" %>
            ...
            <div style="width: 99%">
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="View1" runat="server">
                        <asp:HiddenField ID="IsShift_IPD" runat="server" />
                        <asp:HiddenField ID="IsShift_ICU" runat="server" />
                        <asp:HiddenField ID="IPDBed_Id" runat="server" />
                        <asp:HiddenField ID="ShiftPatient_ID" runat="server" />
                        <asp:HiddenField ID="Bed_Id" runat="server" />
                        <asp:HiddenField ID="Floor_Id" runat="server" />
                        <asp:HiddenField ID="Room_Id" runat="server" />
                        <asp:HiddenField ID="Pat_Id" runat="server" />
                        <asp:HiddenField ID="ICUBed_Id" runat="server" />
                        <table width="100%">
                            <tr>
                                <td align="center">
                                        ...
                                        <tr>
                                            <td align="center" style="border-right: none; width: 575px;">
                                                ...
                                                <cc:TextBoxWatermarkExtender ID="txtSearchWatermark" runat="server" TargetControlID="txtSearch"
                                                    WatermarkCssClass="watermarked" WatermarkText="PatientName,RoomNo,BedId,BedNo,FloorName" />
                                            </td>
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td style="width: 100%" colspan="3">
                                                    ...
                                                    <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="1010px" BorderColor="Green"
                                                        ...
                                                        <asp:GridView ID="dgvDepartment" runat="server" CellPadding="4" ForeColor="#333333"
                                                            ...
                                                            AllowPaging="true" PageSize="50" AutoGenerateColumns="false" OnPageIndexChanged="dgvDepartment_PageIndexChanged"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="AllocationDate" HeaderText="Allocation Date" ReadOnly="true"  DataFormatString="{0:dd/MM/yyyy}"/>
                                                                
                                                                <asp:TemplateField HeaderText="Shift To ICU" ItemStyle-HorizontalAlign="Left" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="imgICUshift" runat="server" ImageUrl="~/images/Knob/Knob Attention.png" Height="24px"
                                                                            Width="24px" OnClick="btnShiftToICU_Click" /></ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Change Bed" ItemStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="ImageChange" runat="server" ImageUrl="~/images/Knob/Knob Attention.png" Height="24px"
                                                                            Width="24px" OnClick="ImageChange_Click" /></ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlPatientName" runat="server" Width="150px" OnSelectedIndexChanged="ddlPatientName_SelectedIndexChanged1"
                                                        AutoPostBack="True">
                                                    </asp:DropDownList>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtAllocDate" runat="server" Font-Names="Verdana" Font-Size="11px"
                                                     ...
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                                        ControlToValidate="txtAllocDate" Font-Size="13" ValidationGroup="Save" ErrorMessage="*"
                    ...
                    <asp:View runat="server" ID="View3">
                        <table width="100%" style="border-color: Green; border-style: solid; border-width: 2px"
                            ...
                            <tr style="width: 100%">
                                <td style="width: 100%">
                                    <asp:Panel ID="Panel1" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                        height: 190px;" BorderColor="Green" BorderStyle="Solid" BorderWidth="1px">
                                        <table width="100%">
                                            <tr style="width: 100%;">
                                                <td align="center" colspan="4">
                                                    <asp:Label ID="Label2" runat="server" Text="ICU Bed Allocation To Patient" Font-Names="Verdana"
                                                        Font-Size="15px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="style1">
                                                    <asp:Label ID="lblICUMsg" runat="server" Text="" Font-Names="Verdana" Font-Size="11px"
                                                        ForeColor="Red"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="right" style="width: 25%;">
                                                    <asp:Label ID="lblICUBedNO" runat="server" ForeColor="#3B3535" Text="Bed No. :" />
                                                </td>
                                                <td style="width: 10%;">
                                                    <asp:DropDownList ID="ddlICUBedMaster" runat="server" AutoPostBack="True" Width="150px">
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlICUBedMaster"
                                                        ErrorMessage="*" Font-Size="13" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                                </td>
                                                <td align="right" style="width: 10%;">
                                                    <asp:Label ID="lblICUAllocDate" runat="server" Text="Allocation Date :" Font-Names="Verdana"
                                                        Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                                </td>
                                                <td align="left" style="width: 25%;">
                                                    <asp:TextBox ID="txtICUAlloc" runat="server" Font-Names="Verdana" Font-Size="11px" Width="150px"
                                                        MaxLength="10"></asp:TextBox>
                                                    
                                                    <cc:CalendarExtender ID="CalICUAlloc" runat="server" TargetControlID="txtICUAlloc"
                                                        Format="dd/MM/yyyy" DaysModeTitleFormat="dd/MM/yyyy" TodaysDateFormat="dd/MM/yyyy">
                                                    </cc:CalendarExtender>
                                                </td>
                                            ...
                                            <tr align="center">
                                                <td align="center" colspan="4">
                                                    <asp:Button ID="btnICUSave" runat="server" Text="Shift" Font-Names="Verdana" Font-Size="12px"
                                                        ValidationGroup="Save" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black;
                                                        height: 20px;" OnClick="BtnICUSave_Click" />
                                                   <%-- <asp:Button ID="BtnICUEdit" runat="server" Text="Update" Font-Names="Verdana" Font-Size="12px"
                                                        BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                                                        OnClick="BtnICUEdit_Click" />--%>
                                                    <asp:Button ID="BtnICUClose" runat="server" Text="Close" Font-Names="Verdana" Font-Size="12px"
                                                        BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                                                        OnClick="BtnICUClose_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
